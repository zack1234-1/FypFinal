...
class TodosController extends Controller
{
    ...
    public function index()
    {
        ...
        $todos = Todo::where('workspace_id', $projectId)
                    ->whereJsonContains('user_id', (string) $currentUserId)
                    ->orderBy('created_at', 'desc')
                    ->get();
    ...
    public function markDone($id)
    {
        ...
        return redirect()->route('todos.index')->with('success', 'Todo mark as done successfully.');
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($todo->update($formFields)) 
        {
            ...
            return redirect()->route('todos.index')->with('error', 'Todo cannot be updated successfully.');
        }
    }
    ...
    public function markAsDone($id)
    {
        ...
        return redirect()->back()->with('success', 'Todo marked as done.');
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('todos.index')->with('error', 'Failed to delete Todo.');
        }
    }
