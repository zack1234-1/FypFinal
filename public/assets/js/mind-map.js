...
!(function (e, t) {
    ...
    class h {
        ...
        add_node(e, i, n, o, r, a, d) {
            if (!l.is_node(e))
                return (
                    s.error("the parent_node " + e + " is not a node."), null
                );
        ...
        insert_node_before(e, t, i, n, o) {
            if (!l.is_node(e))
                return (
                    s.error("the node_before " + e + " is not a node."), null
                );
            var r = e.index - 0.5;
        ...
        move_node(e, t, i, n) {
            return l.is_node(e)
                ...
                : (s.error("the parameter node " + e + " is not a node."),
                    null);
        }
        ...
        _move_node_internal(e, t) {
            if (e && t)
                if ("_last_" == t) (e.index = -1), this._update_index(e.parent);
                    ...
                    (e.index = 0), this._update_index(e.parent);
                else {
        ...
        remove_node(e) {
            if (!l.is_node(e))
                return (
                    s.error("the parameter node " + e + " is not a node."), !1
                );
        ...
        _put_node(e) {
            return e.id in this.nodes
                ? (s.warn("the node_id '" + e.id + "' has been already exist."),
                    !1)
                : ((this.nodes[e.id] = e), !0);
        }
        _update_index(e) {
        ...
        u = {
            ...
            freemind: {
                ...
                _load_node: function (e, i, n) {
                    ...
                    if (null == r)
                        for (
                            var d = n.childNodes, l = null, h = 0;
                            h < d.length;
                            h++
                        )
                            if (
                                1 == (l = d[h]).nodeType &&
                                "richcontent" === l.tagName
                            ) {
                                r = l.textContent;
                                break;
                            }
                ...
                _load_attributes: function (e) {
                    for (
                        var t = e.childNodes, i = null, n = {}, o = 0;
                        o < t.length;
                        o++
                    )
                        1 == (i = t[o]).nodeType &&
            ...
            text: {
                ...
                _build_lines: function (e, t, i) {
                    ...
                    for (let o of t)
                        e.push(n + o.topic),
                            o.children &&
                            u.text._build_lines(e, o.children, i + 1);
                },
            },
        };
    class c {
    ...
    class p {
        ...
        calculate_next_child_direction(e) {
            ...
            for (
                var i = e.children || [], n = i.length, o = 0, s = 0;
                s < n;
                s++
            )
        ...
        layout_offset() {
            ...
            for (
                var n = e.children, o = n.length, s = [], r = [], a = null;
                o--;
            ...
            for (
                ...
                (r = (o = e[n])._data.layout),
                    ...
                    (r.offset_x =
                        ...
                        (d.view.width * (d.layout.direction + r.direction)) /
                        2),
                    o.parent.isroot ||
                    (r.offset_x += this.opts.pspace * r.direction),
        ...
        get_node_point_out(e) {
            ...
            if (
                ...
                if (e.isroot) (i.x = 0), (i.y = 0);
                    ...
                    (i.x =
                        o.x +
                        (n.width + this.opts.pspace) *
                        e._data.layout.direction),
                        (i.y = o.y);
                }
            return i;
        }
        ...
        toggle_node(e) {
            e.isroot ||
                (e.expanded ? this.collapse_node(e) : this.expand_node(e));
        }
        expand_node(e) {
            (e.expanded = !0),
                this.part_layout(e),
        ...
        part_layout(e) {
            ...
            if (i) {
                ...
                e.isroot
                    ? ((n.outer_height_right =
                        this._layout_offset_subnodes_height(n.right_nodes)),
                        (n.outer_height_left =
                            this._layout_offset_subnodes_height(n.left_nodes)))
                    : e._data.layout.direction == t.right
                        ? (n.outer_height_right =
                            this._layout_offset_subnodes_height(n.right_nodes))
                        : (n.outer_height_left =
    ...
    class v {
        ...
        init_line_render() {
            "function" == typeof this.opts.custom_line_render
                ...
                : (this.drawing =
                    this.line_drawing[this.opts.line_style] ||
                    this.line_drawing.curved);
        }
        element() {
            return this.e_svg;
        }
    ...
    class g {
        constructor(e, t) {
            (this.opts = t),
                ...
                (this.device_pixel_ratio =
                    (this.opts.enable_device_pixel_ratio &&
        ...
        init() {
            if (
                ...
                (this.graph =
                    ((e = this),
                        "svg" === this.opts.engine.toLowerCase()
                            ? new v(e)
                            : new f(e))),
                    ...
                    (this.e_panel.className =
                        "jsmind-inner jmnode-overflow-" +
                        this.opts.node_overflow),
                ...
                r.on(this.e_editor, "keydown", function (e) {
                    ...
                    new IntersectionObserver((e, t) => {
                        e[0].isIntersecting &&
                            (t.unobserve(this.e_panel), this.resize());
        ...
        set_zoom(e, t) {
            ...
            let n = t
                ...
                o =
                    ((this.e_panel.scrollLeft + n.x) * e) / this.zoom_current -
                    n.x,
                s =
                    ((this.e_panel.scrollTop + n.y) * e) / this.zoom_current -
                    n.y;
            this.zoom_current = e;
        ...
        _reset_node_custom_style(e, t) {
            if (
                ("background-color" in t &&
                    ...
                    "foreground-color" in t &&
                    (e.style.color = t["foreground-color"]),
        ...
        restore_selected_node_custom_style(e) {
            ...
            "background-color" in i &&
                ...
                "foreground-color" in i &&
                (t.style.color = i["foreground-color"]);
        }
        ...
        center_node(e) {
            if (!this.layout.is_visible(e))
                return (
                    s.warn(
                        "can not scroll to the node, because it is invisible"
                    ),
                    !1
                );
            let t = e._data.view,
    ...
    class m {
        ...
        handler(e) {
            if (
                (9 == e.which && e.preventDefault(), !this.jm.view.is_editing())
            ) {
                var t = e || event;
    ...
    class z {
            ...
            if (!this.initialized) {
                ...
                var e = {
                    ...
                    t = {
                        ...
                        custom_line_render:
                            this.options.view.custom_line_render,
                        ...
                        custom_node_render:
                            this.options.view.custom_node_render,
        ...
        mousedown_handle(e) {
            if (this.options.default_event_handle.enable_mousedown_handle) {
                ...
                i
                    ? this.view.is_node(t) && this.select_node(i)
                    : this.select_clear();
            }
        }
        click_handle(e) {
        ...
        add_node(e, n, o, r, a) {
            if (this.get_editable()) {
                var d = this.get_node(e),
                    l = t.of(a);
                void 0 === l &&
                    (l = this.layout.calculate_next_child_direction(d));
        ...
        remove_node(e) {
            ...
            if (this.get_editable()) {
                if (e.isroot)
                    return s.error("fail, can not remove root node"), !1;
                var n = e.id,
                    o = e.parent.id,
                    r = this.get_node(o);
                return (
        ...
        select_clear() {
            this.mind &&
                ((this.mind.selected = null), this.view.select_clear());
        }
        is_node_visible(e) {
