                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach(json_decode($plan->modules ?? '[]') as $module)
                                        <span class="badge bg-label-dark">{{ $module }}</span>
                                    @endforeach
                                </td>
                                <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            @foreach(['todo' => 'To-Do', 'notes' => 'Notes', 'meetings' => 'Meetings', 'messageBoards' => 'Message Boards'] as $value => $label)
                                <div class="form-check form-switch">
                                    <input type="checkbox" name="modules[]" value="{{ $value }}" class="form-check-input" id="feature_{{ $value }}">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                @foreach(['todo' => 'To-Do', 'notes' => 'Notes', 'meetings' => 'Meetings', 'messageBoards' => 'Message Boards'] as $value => $label)
                                    <div class="form-check form-switch">
                                        <input type="checkbox" name="modules[]" value="{{ $value }}" class="form-check-input" id="feature_{{ $value }}{{ $plan->id }}" {{ in_array($value, $selectedModules) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="feature_{{ $value }}{{ $plan->id }}">{{ $label }}</label>
                                    </div>
                                @endforeach
                            </div>
                        </div>
